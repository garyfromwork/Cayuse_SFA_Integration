select distinct 
    ...
    ' ' "SecondaryCode",
    (CASE
        WHEN ORGN IN ('11001','20001','30001','40010','50011') 
        THEN '11001'
        WHEN ORGN IN ('15001','15002','15008','90011','95101') 
        THEN '15001'
        WHEN ORGN IN ('20002','20011','20015','20019','20023',
            '20026','21001','22010','23011','24001','25001',
            '26001','27001','27002','28001','29001','29101',
            '29103','29130','29200','29204','29302','29304',
            '29311','29401','29501','29502','29504','60011') 
        THEN '20001'
        WHEN ORGN IN ('21200','21300','21400','21500') 
        THEN '21001'
        WHEN ORGN IN ('22012','22017','22100','22104','22105',
            '22107','22108','22200','22201','22203','22222',
            '22300','22400','22405','22500','22506','22510',
            '22514','22601','22604','22607','22705','22706') 
        THEN '22010'
        WHEN ORGN IN ('23014','23015','23016','23100','23114',
            '23115','23117','23200','23201','23202','23203',
            '23207','23210','23211','23300') 
        THEN '23011'
        WHEN ORGN IN ('24100','24101','24102','24103','24104',
            ...
            '24304') 
        THEN '24001'
        WHEN ORGN IN ('25002','25003','25004','25100','25109',
            '25200','25202','25206','25215','25300','25400',
            '25401','25500','25600','25601','25602','25700',
            '25750','25800','25900','25902','25911','25913')
        THEN '25001'
        WHEN ORGN IN ('26002','26004','26008','26010','26011',
            '26050','26100','26200','26300','26400','26410',
            '26414','26500','26501','26510','26600','26602',
            '26701','26708','26800')
        THEN '26001'
        WHEN ORGN IN ('27101','27201')
        THEN '27001'
        WHEN ORGN IN ('29002','29003','29007','29011','29012','29013')
        THEN '29001'
        WHEN ORGN IN ('30101','30201','30401','30501','30601','31001')
        THEN '30001'
        WHEN ORGN IN ('30204','30205','30206','30207','30209','30210',
            '30212','30216','30232','30249','30251','30254','30257','30258')
        THEN '30201'
        WHEN ORGN IN ('30604')
        THEN '30604'
        WHEN ORGN IN ('31002','31003')
        THEN '31001'
        WHEN ORGN IN ('40011','40017','80010')
        THEN '40010'
        WHEN ORGN IN ('51001','52001','52101','53701','54011','55011','57001',
            '57011')
        THEN '50011'
        WHEN ORGN IN ('51005')
        THEN '51001'
        WHEN ORGN IN ('52002','52003','52004','52005','52201','52301','52401',
            '53101','53401')
        THEN '52001'
        WHEN ORGN IN ('52103','52109','52110')
        THEN '52101'
        WHEN ORGN IN ('52205','52206','52207','52208')
        THEN '52201'
        WHEN ORGN IN ('52302','52303')
        THEN '52301'
        WHEN ORGN IN ('53103')
        THEN '53101'
        WHEN ORGN IN ('53431','53435')
        THEN '53401'
        WHEN ORGN IN ('55016')
        THEN '55011'
        WHEN ORGN IN ('90016')
        THEN '90011'
        WHEN ORGN IN ('95102','95105','95106','95109','95112','95113','95201',
            '95202','95401','95402','95601','96021','96031','96041','96051',
            '96061','97021','97031','97041','97051','97061','97071','97081',
            '97091','97101')
        THEN '95101'
        ELSE ORGN END) "ParentUnitPrimaryCode",
    (CASE ORGN WHEN '15002' THEN 'No'
        ELSE 'Yes' END) "Active" 
from ftvorgn b
