...
SELECT DISTINCT PEOPLE.TITLE, PEOPLE.USERNAME Username,
        ...
        ' ' Unit,
        ' ' IncludeAllSubUnits
FROM PEOPLE WHERE PEOPLE.TITLE IN ('DEANS/CHAIRS', 'DIRECTORS')  -- SP Proposal Reviewer
UNION
SELECT DISTINCT PEOPLE.TITLE, PEOPLE.USERNAME Username,
...
SELECT DISTINCT PEOPLE.TITLE, PEOPLE.USERNAME Username,
        ...
        ' ' Unit,
        ' ' IncludeAllSubUnits
FROM PEOPLE WHERE (PEOPLE.TITLE IN ('DIRECTORS', 'DEANS/CHAIRS')  -- SP Award Reviewer
	OR PEOPLE.ORG = '11011')
UNION
SELECT DISTINCT PEOPLE.TITLE, PEOPLE.USERNAME Username,
